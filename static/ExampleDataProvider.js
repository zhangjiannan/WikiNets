...
(function() {
  ...
  define(["DataProvider"], function(DataProvider) {
    ...
    */
    ...
    var ExampleDataProvider, graph, _ref;
    graph = {
      "A": {
        "B": 1.0
      },
    ...
    return ExampleDataProvider = (function(_super) {
      __extends(ExampleDataProvider, _super);

      function ExampleDataProvider() {
        _ref = ExampleDataProvider.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      */
      ...
      ExampleDataProvider.prototype.getLinks = function(node, nodes, callback) {
      ...
      */
      ...
      ExampleDataProvider.prototype.getLinkedNodes = function(nodes, callback) {
